...
#define LV_MEM_CUSTOM 0
    ...
    #define LV_MEM_CUSTOM_ALLOC(x)   heap_caps_malloc(x,  MALLOC_CAP_SPIRAM | MALLOC_CAP_8BIT)
    #define LV_MEM_CUSTOM_FREE    heap_caps_free
    #define LV_MEM_CUSTOM_REALLOC(x,y)  heap_caps_realloc(x, y, MALLOC_CAP_SPIRAM | MALLOC_CAP_8BIT);
#endif     /*LV_MEM_CUSTOM*/
